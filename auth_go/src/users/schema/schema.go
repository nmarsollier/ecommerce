...
func NewFromBson(document bson.Document) User {
	return User{
...
// HashPassword setea el password del usuario
func (e *User) HashPassword(pwd string) error {
...
// ValidatePassword verifica si el password del parametro es el del usuario
